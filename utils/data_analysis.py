...
def plot_multi_results(path, interval=500):
    ...
    plt.plot(dqn_ma, label='dqn')
    plt.plot(prior_0_1_ma, label='dqn_prior-0.1')
    plt.plot(prior_0_2_ma, label='dqn_prior-0.2')
    plt.plot(prior_0_4_ma, label='dqn_prior-0.4')
    plt.plot(prior_0_6_ma, label='dqn_prior-0.6')
    plt.plot(prior_0_8_ma, label='dqn_prior-0.8')
    plt.plot(prior_1_0_ma, label='dqn_prior-1.0')
    plt.title("Moving average of step_reward in {}".format(interval))
    plt.legend(loc='best')
    plt.show()
