...
class Maze(tk.Tk, object):
    ...
    def step(self, action):
        ...
        if self.full:
            ...
            self.current_player = [[int(s_[0] // self.unit), int(s_[1] // self.unit)]]
            obser = self.observe()
            return obser.T.flatten(), reward, done, info
        else:
